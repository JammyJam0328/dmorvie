              ...
              <svg class="absolute top-0 left-1/2 transform translate-x-64 -translate-y-8" width="640" height="784" fill="none" viewBox="0 0 640 784">
                <defs>
                  <pattern id="9ebea6f4-a1f5-4d96-8c4e-4c2abf658047" x="118" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                    <rect x="0" y="0" width="4" height="4" class="text-blue-300" fill="currentColor" />
                  </pattern>
                </defs>
                <rect x="118" width="404" height="784" fill="url(#9ebea6f4-a1f5-4d96-8c4e-4c2abf658047)" />
              </svg>
            </div>
            <div class="bg-blue-300 absolute top-0 left-1/2 transform translate-x-64 -translate-y-8 h-full mt-20 w-full bg-opacity-50 rounded-l-lg">
            <div class="relative  h-full">
                <img src="https://images.unsplash.com/photo-1541971875076-8f970d573be6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80" class="absolute top-0 rounded-l-lg shadow-xl opacity-50" alt="">
            </div>
            </div>
                  ...
                  <div class="flex items-center flex-1">
                    <div class="flex items-center justify-between w-full md:w-auto">
                      <a href="#">
                        ...
                        <img class="h-8 w-auto sm:h-10" src="{{asset('images/dmorvielogo.png')}}" alt="">
                      </a>
              ...
              <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6 lg:mt-16 ">
                <div class="lg:grid lg:grid-cols-12 lg:gap-2">
                  <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                    <h1>
                      <span class="block text-sm font-semibold uppercase tracking-wide text-gray-500 sm:text-base lg:text-sm xl:text-base">Welcome</span>
                      <span class="mt-1 block text-4xl tracking-tight  ">
                        <span class="block uppercase text-6xl font-black font-inter text-gray-700">D'Morvie Suites</span>
                        <span class="block font-inter text-2xl font-bold text-blue-900">Your Cheaper and Satisfying Stay in Town</span>
                      </span>
                    </h1>
                    ...
                    <div class=" max-w-lg mx-auto grid gap-3 lg:grid-cols-4 lg:max-w-none">
                        <div class="flex flex-col rounded-md shadow-lg overflow-hidden">
                          ...
                          <div class="flex-1 bg-white p-1 flex flex-col justify-between">
                            <div class="flex-1">
                          ...
                          <div class="flex-1 bg-white p-1 flex flex-col justify-between">
                            <div class="flex-1">
                              <p class="text-xs uppercase font-semibold text-blue-700">
                                ...
                                <p class="text-xs text-gray-700">Yacapin Corner Velez Streets, Cagayan de Oro City</p>
                            </div>
                          </div>
                        </div>
                        <div class="flex flex-col rounded-md shadow-lg overflow-hidden">
                          ...
                          <div class="flex-1 bg-white p-1 flex flex-col justify-between">
                            <div class="flex-1">
                              <p class="text-xs uppercase font-semibold text-blue-700">
                                ...
                                <p class="text-xs text-gray-700">Yacapin Corner Capistrano Streets, Cagayan de Oro City</p>
                            </div>
                          </div>
                        </div>
                        <div class="flex flex-col rounded-md shadow-lg overflow-hidden">
                          ...
                          <div class="flex-1 bg-white p-1 flex flex-col justify-between">
                            <div class="flex-1">
                              <p class="text-xs uppercase font-semibold text-blue-700">
                                ...
                                <p class="text-xs text-gray-700">J.C. Aquino Avenue, Brgy. Tandang Sora, Butuan City</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    <div class="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                      <p class="text-base mb-2 font-medium text-gray-900">Please sign in to get started.</p>
                        <a href="" class="bg-gray-700  px-2 py-1 text-white rounded-md">
                            Sign In
                        </a>
