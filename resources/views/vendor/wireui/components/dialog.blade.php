<div class="fixed inset-0 overflow-y-auto {{ $zIndex }}"
    ...
    <div class="flex items-end {{ $align }} sm:pt-16 min-h-screen justify-center"
        ...
        <div class="w-full p-4 transition-all sm:max-w-lg"
            ...
            <div class="relative p-4 space-y-4 overflow-hidden bg-white shadow-md dark:bg-secondary-800 rounded-xl"
                :class="{
                ...
                <div x-show="dialog && dialog.closeButton"
                ...
                <div class="grid grid-cols-1 gap-y-2 sm:gap-x-3"
                    ...
                    <div x-show="dialog && dialog.accept"
                        class="sm:order-last"
                        x-ref="accept"></div>
                    <div x-show="dialog && dialog.reject"
                        x-ref="reject"></div>
                </div>
