<x-layouts.kitchen>
    ...
    <ul role="list"
        class="mt-2 grid grid-cols-1 gap-5 sm:gap-2 sm:grid-cols-2 lg:grid-cols-5">
    ...
    @if (Request::routeIs('kitchen'))
        <div class="flex justify-between px-2 items-center">
            <h1 class="text-xl font-bold font-inter uppercase">Dashboard</h1>
                ...
                <ol role="list" class="flex items-center space-x-1">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <a href="#" class=" font-inter text-sm font-semibold text-gray-500 hover:text-gray-700" aria-current="page">Dashboard</a>
                    </div>
                  </li>
                </ol>
              </nav>
