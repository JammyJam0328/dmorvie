<x-layouts.kitchen>
 ...
 c1.8-1.7,3.6-4.9,6.4-4.9c-1.4,3-2.7,3.4,0.8,5.3C46.1,15.4,49.1,16.9,51.9,18.7z" />
    ...
    @section('order-transaction')
        ...
        <div class=" h-96 px-2 py-2">
            <div class=" overflow-hidden">
                <ul role="list" class="divide-y divide-gray-200">
                    <li class="bg-gray-200 mb-2 rounded-lg shadow">
                        <div class="block">
                            <div class="flex items-center">
                                <div class="py-4 pl-4">
                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                        class="h-7 text-gray-700 w-7" xmlns:xlink="http://www.w3.org/1999/xlink"
		...
		C58,50.829,47.096,55.098,30,55.098z" />
                                ...
                                <div class="px-2 py-4 sm:px-2 flex-1 ">
                                    <div class="flex-1 flex items-end justify-between">
                                        <div class="text-green-700 uppercase font-bold font-inter truncate">CORNSILOG</div>
                                        <div class="flex bg-white shadow rounded-full">
                                            <button class="bg-green-500 hover:bg-green-600 text-white rounded-full px-2">-</button>
                                            <div class="px-4 text-gray-700">1</div>
                                            <button class="bg-green-500 hover:bg-green-600 text-white rounded-full px-2">+</button>
                                        </div>
                                    </div>
                                    <div class="mt-1 flex px-2 items-center justify-between">
        ...
        <div class="bg-gray-100 rounded-md p-2 mx-2">
            <section aria-labelledby="summary-heading" class=" rounded-lg  lg:col-span-5">
                <h2 id="summary-heading" class="text-lg font-bold uppercase font-inter text-gray-800">Order summary</h2>
                ...
                <dl class="mt-3 space-y-4">
                  ...
                  <div class="border-t-2 border-dashed border-gray-600 pt-2 flex items-center justify-between">
                    <dt class="font-bold uppercase font-inter text-green-700">Total</dt>
                    <dd class="font-bold uppercase font-inter text-green-700">&#8369;112.32</dd>
                  </div>
                </dl>
        
                <div class="mt-6">
                  <button type="submit" class="w-full bg-gray-600 uppercase font-bold border border-transparent rounded-md shadow-sm py-2 px-4 font-inter text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500">Checkout</button>
                </div>
              </section>
        </div>
    @endsection
    ...
    <li
        ...
        <div class="flex-1 flex flex-col p-5">
            <div class="flex justify-center items-center">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                class="h-20 text-gray-700 w-20" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" viewBox="0 0 60 60"
                style="enable-background:new 0 0 60 60;" xml:space="preserve">
                <g>
                    <path
